...
namespace DestinyItemTaggerTests
{
    ...
    public class armourTagItemsTests
    {
        ...
        public void armourPowerLevelNotMet()
        {
            ...
            Assert.IsTrue(taggedArmourList[0][taggedArmourList[0].Length - 3] != "infuse", "Perk score matched armour not tagged \"keep\".");
        }

        [TestMethod]
        public void armourPowerLevelMet()
        {
            string[][] destinyArmourPieces = new string[1][];
            destinyArmourPieces[0] = new string[31] { "Tangled Web Hood", "1664085089", "\"6917529097117115204\"", "", "Legendary", "Helmet", "", "Warlock", "732", "Void Damage Resistance", "1", "Warlock(750)", "FALSE", "FALSE", "2", "4", "", "5", "1", "2", "1", "0", "", "Mobile Warlock Armor*", "Mobility Enhancement Mod*", "Restorative Mod", "Tier 1 Armor*", "Sniper Rifle Targeting*", "Light Reactor", "Linear Fusion Rifle Reserves*", "Shotgun Reserves" };
            string itemType = "Armour";
            string currentPowerLevel = "700";
        ...
        [TestMethod]
        public void armourPerkSetOverride()
        {
            string[][] destinyArmourPieces = new string[1][];
            destinyArmourPieces[0] = new string[31] { "Tangled Web Hood", "1664085089", "\"6917529097117115204\"", "", "Legendary", "Helmet", "", "Warlock", "732", "Void Damage Resistance", "1", "Warlock(750)", "FALSE", "FALSE", "2", "4", "", "5", "1", "2", "1", "0", "", "Mobile Warlock Armor*", "Mobility Enhancement Mod*", "Restorative Mod", "Tier 1 Armor*", "Sniper Rifle Targeting*", "Light Reactor", "Linear Fusion Rifle Reserves*", "Shotgun Reserves" };
            string itemType = "Armour";
        ...
        [TestMethod]
        public void armourPerkRecommendationOverride()
        {
            string[][] destinyArmourPieces = new string[1][];
            destinyArmourPieces[0] = new string[31] { "Tangled Web Hood", "1664085089", "\"6917529097117115204\"", "", "Legendary", "Helmet", "", "Warlock", "732", "Void Damage Resistance", "1", "Warlock(750)", "FALSE", "FALSE", "2", "4", "", "5", "1", "2", "1", "0", "", "Mobile Warlock Armor*", "Mobility Enhancement Mod*", "Restorative Mod", "Tier 1 Armor*", "Sniper Rifle Targeting*", "Light Reactor", "Linear Fusion Rifle Reserves*", "Shotgun Reserves" };
            string itemType = "Armour";
            ...
            Assert.IsTrue(taggedArmourList[0][taggedArmourList[0].Length - 3] == "keep", "Perk set did not override perk score.");
        }
    }
    ...
    public class weaponTagItemsTests
    {
        ...
        public void weaponPerkSetMatch()
        {
            ...
            string[][] taggedWeaponList = Program.TagItems(destinyWeaponPieces, itemType, currentPowerLevel, weaponPerkSets, typedPerkSet, weaponPerkRecommendations, perkScoreLevel);
        ...
        public void weaponPerkScoreNotMet()
        {
            ...
            string[][] taggedArmourList = Program.TagItems(destinyWeaponPieces, itemType, currentPowerLevel, weaponPerkSets, typedPerkSet, weaponPerkRecommendations, perkScoreLevel);
        ...
        [TestMethod]
        public void weaponPowerLevelNotMet()
        {
            string[][] destinyWeaponPieces = new string[1][];
            destinyWeaponPieces[0] = new string[38] { "The Huckleberry", "2286143274", "\"6917529095680493737\"", "", "Exotic", "Submachine Gun", "", "750", "Kinetic", "", "", "Warlock(750)", "TRUE", "FALSE", "1", "3", "", "4.7", "152", "100", "49", "22", "58", "56", "750", "10", "37", "87", "0", "0", "0", "", "Ride the Bull*", "Fluted Barrel*", "Ricochet Rounds*", "Rampage*", "Short-Action Stock*", "Huckleberry Catalyst*" };
            string itemType = "Weapon";
            string currentPowerLevel = "800";
        ...
        [TestMethod]
        public void weaponPowerLevelMet()
        {
            string[][] destinyWeaponPieces = new string[1][];
            destinyWeaponPieces[0] = new string[38] { "The Huckleberry", "2286143274", "\"6917529095680493737\"", "", "Exotic", "Submachine Gun", "", "750", "Kinetic", "", "", "Warlock(750)", "TRUE", "FALSE", "1", "3", "", "4.7", "152", "100", "49", "22", "58", "56", "750", "10", "37", "87", "0", "0", "0", "", "Ride the Bull*", "Fluted Barrel*", "Ricochet Rounds*", "Rampage*", "Short-Action Stock*", "Huckleberry Catalyst*" };
            string itemType = "Weapon";
        ...
        [TestMethod]
        public void weaponPerkSetOverride()
        {
            string[][] destinyWeaponPieces = new string[1][];
            destinyWeaponPieces[0] = new string[38] { "The Huckleberry", "2286143274", "\"6917529095680493737\"", "", "Exotic", "Submachine Gun", "", "750", "Kinetic", "", "", "Warlock(750)", "TRUE", "FALSE", "1", "3", "", "4.7", "152", "100", "49", "22", "58", "56", "750", "10", "37", "87", "0", "0", "0", "", "Ride the Bull*", "Fluted Barrel*", "Ricochet Rounds*", "Rampage*", "Short-Action Stock*", "Huckleberry Catalyst*" };
            string itemType = "Weapon";
        ...
        [TestMethod]
        public void weaponPerkRecommendationOverride()
        {
            string[][] destinyWeaponPieces = new string[1][];
            destinyWeaponPieces[0] = new string[38] { "The Huckleberry", "2286143274", "\"6917529095680493737\"", "", "Exotic", "Submachine Gun", "", "750", "Kinetic", "", "", "Warlock(750)", "TRUE", "FALSE", "1", "3", "", "4.7", "152", "100", "49", "22", "58", "56", "750", "10", "37", "87", "0", "0", "0", "", "Ride the Bull*", "Fluted Barrel*", "Ricochet Rounds*", "Rampage*", "Short-Action Stock*", "Huckleberry Catalyst*" };
            string itemType = "Weapon";
    ...
    { 
        ...
        public void TestDataMethod()
        {
            ...
            string[][] taggedArmourList = Program.TagItems(destinyArmourPieces, itemType, currentPowerLevel, armourPerkSets, false, armourPerkRecommendations, perkScoreLevel);
            ...
            taggedArmourList = Program.TagItems(destinyArmourPieces, itemType, currentPowerLevel, armourPerkSets, false, armourPerkRecommendations, perkScoreLevel);
